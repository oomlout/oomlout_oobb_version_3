// Generated by SolidPython 1.1.3 on 2023-03-13 09:53:33
$fn = 50;
...
def get_opsc_item(params):
    ...
    basic_shapes = ['cube', 'sphere', 'cylinder', 'polygon']
    ...
    if params['shape'] in basic_shapes:
        ...
        allowed_keys = {'size', 'r', 'r1', 'r2', 'd', 'h', 'rw', 'rh', 'dw', 'dh','points'}
...
def opsc_easy(type, shape, **kwargs):
    ...
    for param in ['size', 'r', 'r1', 'r2', 'd', 'h', 'rw', 'rh', 'dw', 'dh', 'pos', 'x', 'y', 'z', 'rot', 'rotX', 'rotY', 'rotZ', "w", "inclusion", 'sides']:
        if param in kwargs:
...
def regular_polygon(sides, radius):
    angles = [i * 360 / sides for i in range(sides)]
    points = [(radius * right(a) * up(0)) for a in angles]
