// Generated by SolidPython 1.1.3 on 2023-03-13 10:14:22
$fn = 50;
...
def get_opsc_item(params):
    ...
    if params['shape'] in basic_shapes:
        ...
        return_value = linear_extrude(h)(return_value)
        return return_value
...
def opsc_easy(type, shape, **kwargs):
    ...
    for param in ['size', 'r', 'r1', 'r2', 'd', 'h', 'rw', 'rh', 'dw', 'dh', 'pos', 'x', 'y', 'z', 'rot', 'rotX', 'rotY', 'rotZ', "w", "inclusion", 'sides', 'height']:
        if param in kwargs:
