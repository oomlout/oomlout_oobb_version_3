...
difference() {
	...
	union() {
		translate(v = [-9.5000000000, 11.5000000000, -50]) {
			rotate(a = [0, 0, 0]) {
				cube(size = [4, 2, 100]);
			}
		}
		translate(v = [-9.5000000000, 16.5000000000, -50]) {
			rotate(a = [0, 0, 0]) {
				cube(size = [4, 2, 100]);
			}
		}
		...
		translate(v = [5.5000000000, 11.5000000000, -50]) {
			rotate(a = [0, 0, 0]) {
				cube(size = [4, 2, 100]);
			}
		}
		translate(v = [5.5000000000, 16.5000000000, -50]) {
			rotate(a = [0, 0, 0]) {
				cube(size = [4, 2, 100]);
			}
		}
