// Generated by SolidPython 1.1.3 on 2023-03-13 13:19:15
$fn = 50;
...
def get_opsc_item(params):
    ...
    if params['shape'] in basic_shapes:
        ...
        # Call the corr
        # 
        # esponding function for the shape parameter, using ** notation to pass the shape_params dictionary as keyword arguments
        return get_opsc_transform(params,globals()[params['shape']](**shape_params))
