...
difference() {
	...
	union() {
		...
		translate(v = [-11, 0, -131.0000000000]) {
			rotate(a = [0, 0, 0]) {
				cylinder(h = 250, r = 3.2500000000);
			}
		}
		translate(v = [-20, 8.5000000000, -4.9000000000]) {
			rotate(a = [0, 0, 0]) {
				cylinder(h = 1.9000000000, r1 = 1.8000000000, r2 = 3.6000000000);
			}
		}
		translate(v = [-20, 8.5000000000, -3.0000000000]) {
			rotate(a = [0, 0, 0]) {
				cylinder(h = 250, r1 = 3.6000000000, r2 = 3.6000000000);
			}
		}
		translate(v = [-20, 8.5000000000, -28]) {
			rotate(a = [0, 0, 0]) {
		...
		translate(v = [-54.0000000000, -7.0000000000, -56]) {
			rotate(a = [0, 0, 0]) {
				cube(size = [28, 14, 100]);
			}
		}
