...
difference() {
	...
	union() {
		...
		translate(v = [-2.5000000000, 16.5000000000, -19.0000000000]) {
			rotate(a = [0, 0, 0]) {
				cube(size = [5, 3, 0.3000000000]);
			}
		}
		translate(v = [-2.5000000000, 15.5000000000, -18.7000000000]) {
			rotate(a = [0, 0, 0]) {
		...
		translate(v = [-2.5000000000, -19.5000000000, -19.0000000000]) {
			rotate(a = [0, 0, 0]) {
				cube(size = [5, 3, 0.3000000000]);
			}
		}
		translate(v = [-2.5000000000, -20.5000000000, -18.7000000000]) {
			rotate(a = [0, 0, 0]) {
				cube(size = [5, 5, 0.3000000000]);
			}
		}
