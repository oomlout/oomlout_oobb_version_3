				...
				union() {
					difference() {
						...
						union() {
							...
							translate(v = [39.0000000000, 46.0000000000, 0.6000000000]) {
								rotate(a = [0, 0, 0]) {
									cube(size = [13.0000000000, 6, 16.4000000000]);
								}
							}
							translate(v = [10.4000000000, 46.0000000000, 12.5000000000]) {
								rotate(a = [0, 0, 0]) {
									cube(size = [41.6000000000, 6, 1.5000000000]);
								}
							}
