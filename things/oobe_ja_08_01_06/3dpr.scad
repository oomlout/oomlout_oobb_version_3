...
difference() {
	union() {
		...
		translate(v = [-29.7500000000, 0, -3.0000000000]) {
			rotate(a = [0, 0, 0]) {
				cube(size = [59.5000000000, 6.7500000000, 6]);
			}
		}
	}
	union() {
		...
		translate(v = [-26.2500000000, 6.7500000000, 0]) {
			rotate(a = [90, 0, 0]) {
				cylinder(h = 6.7500000000, r = 1.7000000000);
			}
		}
		translate(v = [-26.2500000000, 4, 0]) {
		...
		translate(v = [-22.5000000000, 6.7500000000, 2.0500000000]) {
			rotate(a = [0, 0, 0]) {
		...
		translate(v = [-15.0000000000, 6.7500000000, -2.0500000000]) {
			rotate(a = [0, 180, 0]) {
				cylinder(h = 0.9500000000, r1 = 0.9000000000, r2 = 1.8000000000);
			}
		}
