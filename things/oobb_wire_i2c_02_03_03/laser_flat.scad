			...
			intersection() {
				...
				difference() {
					...
					union() {
						...
						translate(v = [15.5670000000, -4.0800000000, 0]) {
							rotate(a = [0, 0, 0]) {
								cube(size = [5, 8.1600000000, 3]);
							}
						}
						translate(v = [-7.1460000000, -7.6200000000, 0]) {
							rotate(a = [0, 0, 0]) {
								cube(size = [6, 12.7000000000, 3]);
							}
						}
						translate(v = [1.5380000000, -5.0800000000, 0]) {
							rotate(a = [0, 0, 0]) {
								cube(size = [14, 10.1600000000, 3]);
							}
						}
						translate(v = [-1.0000000000, -10.1600000000, 0]) {
							rotate(a = [0, 0, 0]) {
