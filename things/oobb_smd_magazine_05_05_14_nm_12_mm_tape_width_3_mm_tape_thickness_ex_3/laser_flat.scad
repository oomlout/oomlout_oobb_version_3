				...
				union() {
					difference() {
						...
						union() {
							...
							translate(v = [27.7500000000, 31.0000000000, 0.6000000000]) {
								rotate(a = [0, 0, 0]) {
									cube(size = [9.2500000000, 6, 16.4000000000]);
								}
							}
							translate(v = [7.4000000000, 31.0000000000, 12.5000000000]) {
								rotate(a = [0, 0, 0]) {
									cube(size = [29.6000000000, 6, 1.5000000000]);
								}
							}
