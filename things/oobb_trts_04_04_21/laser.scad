...
difference() {
			...
			rotate(a = [0, 0, 0]) {
				difference() {
					...
					translate(v = [0, 0, 0.5000000000]) {
						hull() {
							union() {
								translate(v = [-25.0000000000, 25.0000000000, 4.5000000000]) {
									rotate(a = [0, 0, 0]) {
										translate(v = [0, 0, 0]) {
											rotate(a = [0, 0, 0]) {
								...
								translate(v = [-25.0000000000, 25.0000000000, 116.5000000000]) {
									rotate(a = [0, 0, 0]) {
										sphere(r = 4.5000000000);
									}
								}
	...
	union() {
		translate(v = [-22.5000000000, -22.5000000000, -50]) {
			rotate(a = [0, 0, 0]) {
		...
		translate(v = [-22.5000000000, -22.5000000000, 21]) {
			rotate(a = [0, 180, 0]) {
