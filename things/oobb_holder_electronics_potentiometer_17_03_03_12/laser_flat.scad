			...
			intersection() {
				...
				difference() {
					...
					union() {
						...
						translate(v = [-8.8500000000, -1.6500000000, 10.5000000000]) {
							rotate(a = [0, 0, 0]) {
								cube(size = [1.7000000000, 3.3000000000, 3.1000000000]);
							}
						}
						translate(v = [-9.0000000000, -12.0000000000, -12.5000000000]) {
							rotate(a = [0, 0, 0]) {
								cube(size = [18, 12.5000000000, 23]);
							}
						}
						translate(v = [-6.5000000000, -16.5000000000, -12.5000000000]) {
							rotate(a = [0, 0, 0]) {
