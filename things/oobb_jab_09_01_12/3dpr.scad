...
difference() {
	...
	union() {
		...
		translate(v = [-65.1126516464, 9, -25]) {
			rotate(a = [90, 0, 0]) {
		...
		translate(v = [-50.1126516464, 9, -25]) {
			rotate(a = [90, 0, 0]) {
				cube(size = [10.2253032929, 100, 6.3142500000]);
			}
		}
		...
		translate(v = [-35.1126516464, 9, -25]) {
			rotate(a = [90, 0, 0]) {
				cube(size = [10.2253032929, 100, 6.3142500000]);
			}
		}
		...
		translate(v = [-20.1126516464, 9, -25]) {
			rotate(a = [90, 0, 0]) {
				cube(size = [10.2253032929, 100, 6.3142500000]);
			}
		}
		...
		translate(v = [24.8873483536, 9, -25]) {
			rotate(a = [90, 0, 0]) {
				cube(size = [10.2253032929, 100, 6.3142500000]);
			}
		}
		...
		translate(v = [39.8873483536, 9, -25]) {
			rotate(a = [90, 0, 0]) {
				cube(size = [10.2253032929, 100, 6.3142500000]);
			}
		}
		...
		translate(v = [54.8873483536, 9, -25]) {
			rotate(a = [90, 0, 0]) {
				cube(size = [10.2253032929, 100, 6.3142500000]);
			}
		}
