...
difference() {
	...
	union() {
		...
		#translate(v = [7.5200000000, -26.0000000000, 1.8000000000]) {
			rotate(a = [0, 0, 0]) {
				cube(size = [2.7400000000, 52.0000000000, 8.7000000000]);
			}
		}
		#translate(v = [-10.2600000000, -26.0000000000, 1.8000000000]) {
			rotate(a = [0, 0, 0]) {
				cube(size = [2.7400000000, 52.0000000000, 8.7000000000]);
			}
		}
