...
difference() {
	...
	union() {
		...
		translate(v = [-60.0000000000, 8, 0]) {
			rotate(a = [90, 0, 0]) {
				#translate(v = [0, 0, 0]) {
					rotate(a = [0, 0, 0]) {
						linear_extrude(height = 5.1000000000) {
		...
		translate(v = [-52.5000000000, 13.5000000000, 4.3000000000]) {
			rotate(a = [0, 0, 0]) {
		...
		translate(v = [-37.5000000000, 13.5000000000, -4.3000000000]) {
			rotate(a = [0, 180, 0]) {
				cylinder(h = 1.7000000000, r1 = 1.5000000000, r2 = 2.9000000000);
			}
		}
		...
		translate(v = [-22.5000000000, 13.5000000000, 4.3000000000]) {
			rotate(a = [0, 360, 0]) {
				cylinder(h = 1.7000000000, r1 = 1.5000000000, r2 = 2.9000000000);
			}
		}
		...
		translate(v = [-7.5000000000, 13.5000000000, 4.3000000000]) {
			rotate(a = [0, 540, 0]) {
				cylinder(h = 1.7000000000, r1 = 1.5000000000, r2 = 2.9000000000);
			}
		}
