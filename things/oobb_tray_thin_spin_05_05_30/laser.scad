...
difference() {
			...
			rotate(a = [0, 0, 0]) {
				difference() {
					...
					translate(v = [0, 0, 0.5000000000]) {
						hull() {
							union() {
								translate(v = [-32.5000000000, 32.5000000000, 4.5000000000]) {
									rotate(a = [0, 0, 0]) {
										translate(v = [0, 0, 0]) {
											rotate(a = [0, 0, 0]) {
								...
								translate(v = [-32.5000000000, 32.5000000000, 125.5000000000]) {
									rotate(a = [0, 0, 0]) {
										sphere(r = 4.5000000000);
									}
								}
	...
	union() {
		translate(v = [-30.0000000000, -30.0000000000, -50]) {
			rotate(a = [0, 0, 0]) {
		...
		translate(v = [-30.0000000000, -30.0000000000, 30]) {
			rotate(a = [0, 180, 0]) {
