				...
				union() {
					difference() {
						...
						union() {
							...
							translate(v = [22.1250000000, 24.5000000000, 0.6000000000]) {
								rotate(a = [0, 0, 0]) {
									cube(size = [7.3750000000, 5, 16.4000000000]);
								}
							}
							translate(v = [5.9000000000, 24.5000000000, 12.5000000000]) {
								rotate(a = [0, 0, 0]) {
									cube(size = [23.6000000000, 5, 1.5000000000]);
								}
							}
