...
difference() {
	...
	union() {
		...
		translate(v = [-37.5000000000, -7.5000000000, 1.7000000000]) {
			rotate(a = [0, 180, 0]) {
		...
		translate(v = [0.0000000000, -18.0000000000, 1.7000000000]) {
			rotate(a = [0, 180, 0]) {
				cylinder(h = 1.7000000000, r1 = 1.5000000000, r2 = 2.9000000000);
			}
		}
		...
		translate(v = [18.0000000000, 0.0000000000, 1.7000000000]) {
			rotate(a = [0, 180, 0]) {
				cylinder(h = 1.7000000000, r1 = 1.5000000000, r2 = 2.9000000000);
			}
		}
		...
		translate(v = [-20, 8.5000000000, 4.3000000000]) {
			rotate(a = [0, 0, 0]) {
				cylinder(h = 1.7000000000, r1 = 1.5000000000, r2 = 2.9000000000);
			}
		}
