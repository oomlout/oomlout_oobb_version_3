...
def get_bearing(**kwargs):
    ...
    th = thing["components"]
    th.extend(ob.oe(t="positive",s="oobb_cylinder", radius_name=f'bearing_{bearing_name}_od', depth=f"bearing_{bearing_name}_depth"))
    th.extend(ob.oe(t="negative",s="oobb_cylinder", radius_name=f'bearing_{bearing_name}_id', depth=f"bearing_{bearing_name}_depth"))
...
def get_bolt(**kwargs):
    ...
    thing["components"].extend(ob.oe(t="positive",s="oobb_bolt", rn=wid, depth=depth, rotY=0, include_nut=False))
...
def get_screw_socket_cap(**kwargs):
    ...
    thing.update({"components": []})
    thing["components"].extend(ob.oe(t="positive",s="oobb_screw_socket_cap", rn=wid, depth=depth, include_nut=False))
